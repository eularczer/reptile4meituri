...
//    private static final String TUJIDAO_LOCAL_PREFIX = "D:/图集岛爬虫（10001-20000）/";
    ...
    public String step1() {
        ...
        for (int i = MIN_PAGE; i <= MAX_PAGE; i++) {
            ...
            Elements c1Elements = Objects.requireNonNull(document).getElementsByClass("c1");
            Elements aElements = c1Elements.first().getElementsByTag("a");
            ...
            for (Element e : aElements) {
                ...
                // 幂等，保证记录数唯一
                if (tujidaoJpaDAO.findByNumberEquals(tujidaoDO.getNumber()) == null) {
